        ...
        {["25-21","20-16","15-11", "10-6", "5-1"].map((label, index) => {
          ...
          return (
            <p
              ...
              className={`px-3 py-1 text-center text-base md:text-sm lg:text-sm xl:text-base cursor-pointer hover:rounded-md hover:bg-darkerGray transition-all duration-200 ${
