...
export default function Navbar() {
  return (
    <nav className="w-full flex items-center sticky top-0 bg-backgroundColor z-10 border-b border-darkerGray px-4 shadow-md  ">
      ...
      {/* Middle (RankBar) */}
      <div className="hidden md:block  md:w-2/3 md:flex flex-grow justify-center ">
        <RankBar />
      </div>
      ...
      <div className="flex w-1/3 md:w-1/4 items-center justify-end relative">
        <input
          className="bg-backgroundColor placeholder:text-sm placeholder:ml-4 w-full md:w-2/3 text-white border border-blue-600 rounded-md p-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-600"
