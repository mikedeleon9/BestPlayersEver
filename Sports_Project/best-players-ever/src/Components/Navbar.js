...
export default function Navbar() {
  return (
    <nav className="w-full flex flex-col sticky top-0 bg-backgroundColor z-10 px-6 border-b pt-2 ">
      <div className="flex w-2/3 justify-between mb-2">
        ...
        <h1 className="font-Inter font-extrabold text-lg  ">Best Players Ever</h1>
          ...
          <div className="w-1/3 flex items-center relative">
            ...
            <input 
              className="bg-darkerGray placeholder:text-sm placeholder:ml-4 w-full relative text-white border-2 border-blue-600 rounded-full p-1 focus:outline-none focus:ring-2 focus:ring-blue-600" 
